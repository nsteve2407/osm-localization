...
# timeout 220s roslaunch osm-localization osm_pf_stereo.launch config_file:="/home/mkz/catkin_ws/src/osm-localization/config/stereo/seen/local/config_gaussian.yaml"

timeout 220s roslaunch osm-localization osm_pf_stereo.launch config_file:="/home/mkz/catkin_ws/src/osm-localization/config/stereo/seen/local/config_maplite.yaml"

timeout 220s roslaunch osm-localization osm_pf_stereo.launch config_file:="/home/mkz/catkin_ws/src/osm-localization/config/stereo/seen/local/config_exp.yaml"

timeout 220s roslaunch osm-localization osm_pf_stereo.launch config_file:="/home/mkz/catkin_ws/src/osm-localization/config/stereo/seen/local/config_quadratic.yaml"
